    ...
    <section className="hero-shell">
      ...
      <div className="hero-grid">
        <div className="hero-copy">
          <p className="eyebrow">Assistant directory</p>
          <h1>Outsourced Assistants: a service index for clearer staffing decisions.</h1>
          <p className="lead">A redesigned outsourced assistants guide for busy teams hiring outsourced assistants for admin, support, and operations. The page now uses a distinct clean Swiss index layout, industry-specific planning sections, and a conversion path that feels made for this niche.</p>
        ...
        <figure className="hero-media"><img src={site.heroImage || site.serviceImage} alt={site.alt || `${site.brand} planning visual`}/><figcaption>index numbers and strict alignment</figcaption></figure>
      </div>
    </section>
