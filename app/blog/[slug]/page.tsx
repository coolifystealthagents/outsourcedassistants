        ...
        <article className="container guide-article">
          ...
          {campaignGuide ? (
            ...
            <div className="card">
              ...
              {relatedService ? <p data-topical-handoff="calendar-management-service">{relatedService.summary} <a href={relatedService.href}>{relatedService.label}</a>. {'boundary' in relatedService ? relatedService.boundary : 'Keep priority choices, exceptions, and meeting commitments with your team.'}</p> : null}
